...
# Change the bitrate
/bitRate/ && back==1 && video==1 && bitrate==1 && hd==1 { sub(/\\d*/, "17000000"); print; next; }
/bitRate/ && back==1 && video==1 && bitrate==1 && high==1 { sub(/\\d*/, "12000000"); print; next; }
/bitRate/ && back==1 && video==1 && bitrate==1 && low==1 { sub(/\\d*/, "384000"); print; next; }
